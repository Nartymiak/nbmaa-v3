			...
			foreach($result as $tuple){
				...
				if($tuple['StartDate'] != $tempDate){
					...
					if($tuple['StartDate']==$todaysDate) {
						...
						array_push($calendarEvents, "	<div class=\"date\" id=\"" .$tuple['StartDate']. "\"><h5><i class=\"fa fa-calendar\"> </i> Today's Events</h5>
															<div class=\"startDate\">" .$tuple['StartDate']. "</div>
														</div>");

					} else {

						array_push($calendarEvents, "	<div class=\"date\"  id=\"" .$tuple['StartDate']. "\"><h5><i class=\"fa fa-calendar\"> </i> " .date("l, F d, Y", $timestamp). "</h5>
															<div class=\"startDate\">" .$tuple['StartDate']. "</div>
														</div>");
