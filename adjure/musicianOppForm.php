<?php
	...
	$subject = 'Musician Opportunity Form';
	$emailMessage = '<h3>Email from ';
	$webMessage = '<div id="returnForm">' ."\r\n";
	$typeOfForm = '';
	$headers = 'From: musicianOppForm@nbmaa.org' . "\r\n" .
	...
	echo "<h2>Thank you!</h2> <p>The following information has been submitted to our Visitor and Volunteer Experience Department:</p>\r\n";
	echo $webMessage;
	echo "</div>\r\n";
